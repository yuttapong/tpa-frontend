                        ...
                        <ul class="nav nav-tabs nav-tabs-bordered" id="tab_certificate" role="tablist" ref="tabViewRef">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" data-bs-toggle="tab"
                                    data-bs-target="#tab_cert_detail">Detail</button>
                            </li>
                                    ...
                                    <table class="table table-sm">
                                        ...
                                        <tbody>
                                            <tr v-for="(item, index) in items" :key="index">
                                                ...
                                                <td><button type="button" class="btn btn-link fw-bold"
                                                        @click="viewCert(item)">{{ item.cerno
                                                        }}</button>
                                                </td>
                                                <td>
                                                    <span class="badge bg-light text-dark">{{ (item.caldate)
                                                    }}</span>
                                                </td>
