<template>
    <BModal scrollable headerClass="py-1" footerClass="d-block" v-model="showModal" @hide="hide" @ok="submit()"
        buttonSize="sm" size="md">
        <template #header>
            <div class="d-none d-md-inline">
                <div class="d-flex flex-wrap gap-2">
                    <div style="min-width: 60px">
                        <span>#{{ data?.id }}</span>
                        <span class="ms-3">{{ `${data?.name_th} ${data?.lastname_th} (${data?.username}` }})</span>
                    </div>
            ...
            <div class="row mt-2">
                <div class="col-12">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        ...
                        <div> <label for="name">ชื่อ (EN)</label>
                            <BFormInput v-model="form.name" trim id="name" />
                        </div>
                        <div> <label for="lastname">ชื่อ (EN)</label>
                        ...
                        <div> <label for="status">Status</label>
                            <input type="checkbox" class="d-block form-check" v-model="form.status" trim id="status"
