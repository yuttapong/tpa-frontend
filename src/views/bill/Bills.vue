      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <p>
            ...
            <span class="text-wrap"> {{ (`${bill.cert_address_name} ${bill.cert_address_detail}
                          ${bill.cert_address_province} ${bill.cert_address_zipcode} ${bill.cert_address_phone}`).trim() }}</span>
          </p>
        </div>
