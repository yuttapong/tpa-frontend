<template>
    <div>
        <ul class="timeline">
            <li class="event" v-for="(item, key) in props.statuses">
                ...
                <h6 class="fw-bold text-primary">{{ item.status_name }}</h6>
                <div class="description">
                    <small class="ms-3 text-danger"><i class="bi bi-person-circle"></i> {{ item.created_name }}</small>
                    <p>{{ item.remark }}</p>
                </div>
