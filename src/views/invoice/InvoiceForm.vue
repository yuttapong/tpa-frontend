                    ...
                    <table class="table table-sm table-bordered tableFixHead">
                      ...
                      <tbody v-if="invoiceItems">
                        <template v-for="(item, index) in invoiceItems" :key="index">
                          <tr class="">
                            <td scope="row" nowrap>
                              <button type="button" class="btn btn-text text-danger" @click="removeItem(item, index)">
                            ...
                            <td class="text-end" style="width: 250px" nowrap>
                              <div class="input-group input-group-sm">
                                <input type="number" v-model="item.discount_percen"
                                  class="form-control form-control-sm text-end text-danger" style="width: 80px"
                                  placeholder="%" />
                                <span class="input-group-text">%</span>
                                <input type="number" v-model="item.discount"
                                  class="form-control form-control-sm text-end text-danger" style="width: 90px"
                                  placeholder="บาท" />
                              </div>
                            </td>
                            <td class="text-end" style="width: 250px" nowrap>
                              <div class="input-group input-group-sm">
                                <input type="number" v-model="item.discount_customer_percent"
                                  class="form-control form-control-sm text-end text-danger" style="width: 80px"
                                  placeholder="%" />
                                <span class="input-group-text">%</span>
                                <input type="number" v-model="item.discount_customer"
                                  class="form-control form-control-sm text-end text-danger" style="width: 90px"
                                  placeholder="บาท" />
                              </div>
                            </td>
                            <td class="text-end" style="width: 100px">
                              <input type="number" v-model="item.price" class="form-control form-control-sm text-end"
                                style="width: 100px" />
                            </td>
                          ...
                          <tr>
                            ...
                            <ProductMeta :item="item" />
                              ...
                              <input type="text" placeholder="รายละเอียด..."
                                class="float-end form-control form-control-sm" />
                            </td>
                          </tr>
                        </template>
                      </tbody>
