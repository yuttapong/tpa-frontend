      ...
      <div class="row g-2">
        <div class="col-auto">
          <input
            type="date"
            id="commitment_date"
            v-model="formCommitment.commitment_date"
        ...
        <div class="col-auto">
          ...
          <div
            v-for="(c, key) in commitmentPriority"
            :key="key"
            class="form-check form-check-inline px-2 me-3"
          >
            <input
              type="radio"
              :id="'priority' + key"
              v-model="formCommitment.priority"
              :value="c.code"
...
const onChange = () => {
  emit('change', formCommitment.value)
}
